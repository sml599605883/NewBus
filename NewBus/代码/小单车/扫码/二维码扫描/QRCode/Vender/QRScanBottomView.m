...
- (void)configUI {
    ...
    UIButton *inputBtn = [self configButtonWithTitle:@"输入小单车编号" imgName:@""];
    ...
    if (self.showType == ShowTypeAlbum) {
        ...
        //只有输入
        self.inputCodeBtn.frame = CGRectMake(0, 0, btnW, 40);
        self.inputCodeBtn.center = CGPointMake(120, centerY);
    } else {
        self.albumBtn.frame = CGRectMake(0, 0, btnW, btnW);
